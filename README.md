...
- **自动更新**：一键检查更新，更新包托管在 GitHub Releases
...
```bash
npm run check      # 类型检查 + ESLint + 764 个单元测试，一键全跑
```

## 正在开发中

- **社区系统**：应用内已内置「社区」工作区（左侧入口，推荐 / 关注 / 排行 / 我的四页签），当前展示**本地示例数据**——无账号、无在线分享。账号、模组在线分享、模板市场与下载服务将在社区服务器上线后接入。
