...
const FILE_STYLES: Record<string, { bg: string; glyph: string }> = {
  '.json': { bg: '#f9ab00', glyph: '{ }' },
  '.txt': { bg: '#4285f4', glyph: 'T' },
  '.ini': { bg: '#34a853', glyph: 'i' },
  '.cfg': { bg: '#1a73e8', glyph: 'C' },
  '.conf': { bg: '#188038', glyph: 'C' },
  '.md': { bg: '#5f6368', glyph: 'M' },
  '.lua': { bg: '#7b1fa2', glyph: 'L' },
  '.png': { bg: '#0f9d58', glyph: '▨' },
  '.jpg': { bg: '#ea4335', glyph: '▨' },
  '.jpeg': { bg: '#ea4335', glyph: '▨' },
  '.webp': { bg: '#1a73e8', glyph: '▨' },
  '.ogg': { bg: '#e37400', glyph: '♪' },
  '.mp3': { bg: '#e37400', glyph: '♪' },
  '.wav': { bg: '#e37400', glyph: '♪' },
}
